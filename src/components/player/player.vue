    ...
    >
      ...
      >
        <div class="middle-l" :style="middleLStyle">
          ...
          <div class="playing-lyric-wrapper" @click="onPlayingClick">
...
export default {
  ...
  setup() {
    ...
    const { currentLyric, currentLineNum, pureMusicLyric, playingLyric, lyricScrollRef, lyricListRef, playLyric, stopLyric } = useLyric(songReady, currentTime)
    const { currentShow, onPlayingClick, middleLStyle, middleRStyle, onMiddleTouchStart, onMiddleTouchMove, onMiddleTouchEnd } = useMiddleInteractive()
